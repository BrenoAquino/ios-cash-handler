...
extension Localizable {
    ...
    enum Stats {
        ...
        static let emptyDataColumn: String = "Dados insuficientes para compor a exibição gráfica"
        static let emptyCategoryStats: String = "Dados insuficientes para categorizar dados"
