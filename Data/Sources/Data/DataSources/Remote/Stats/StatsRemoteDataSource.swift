...
public protocol StatsRemoteDataSource {
    ...
    func historic(numberMonths: Int) -> AnyPublisher<[MonthStatsDTO], CharlesDataError>
}
...
extension StatsRemoteDataSourceImpl: StatsRemoteDataSource {
    ...
    public func historic(numberMonths: Int) -> AnyPublisher<[MonthStatsDTO], CharlesDataError> {
        return networkProvider.execute(endpoint: Endpoints.historic(numberMonths: numberMonths), keyPath: "data")
    }
}
